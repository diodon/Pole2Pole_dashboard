...
You will fill the metadata section of the IPT installation of the MBON project.
...
4. Licence type: select **Cretive COmmons Attribution (CC-BY) 4.0**. This means that the user must attribute the data to the owner.
...
3. Funding. Add the organization(s) that provide support for the sampling.
...
5. Design description: Copy the sampling design from the official methods for the corresponding sandy beach or rocky shore habitats.
...
3. Upload your files: Go to the section **upload files** and select your files one by one. There will be a page confirming the number of records read and other details that you need to acknowledge. Once your three files are uploaded you will see them in the right side panel
...
You can change the visibility to **PUBLIC** to make your data publicly available.

Congratulations!!! Within few minutes your data will be in OBIS and GBIF. GBIF will provide you with a landing page with a DOI for your data.

Remember that you can always update your data and metadata in the IPT and the changes will be reflected in both systems within minutes.

If you have questions or concerns about this process do not hesitate to contact us.
