...
datafileName = paste0(baseDataDir, "Data_Sheet_RockyShore_GB_Puerto Madryn.xlsx")

## taxa name file Abundance
## datataxonName.Abund = paste0(baseDataDir, "taxonameAbund.csv")  ## not needed anymore
datataxonNameMatched.Abund = paste0(baseDataDir, "taxonameAbund_matched.txt")

## taxa name file Cover
## datataxonName.Cover = paste0(baseDataDir, "taxonameCover.csv")  ## not needed anymore
datataxonNameMatched.Cover = paste0(baseDataDir, "taxonameCover_matched.txt")
...
```{r savefiles}
readr::write_csv(path = paste0(baseDataDir, filenameRoot, siteDF$localityCode[1], "_dashboard_siteDF.csv"), siteDF)
readr::write_csv(path = paste0(baseDataDir, filenameRoot, siteDF$localityCode[1], "_dashboard_occurrence.csv"), Occurrence)
...
readr::write_csv(path = paste0("../data/rocky/", siteDF$countryCode[1], "-", siteDF$localityCode[1], "_ipt_event.csv"), eventFile)
...
readr::write_csv(path = paste0("../data/rocky/", siteDF$countryCode[1], "-", siteDF$localityCode[1], "_ipt_occurrence.csv"), occurrenceFile)
...
readr::write_csv(path = paste0("../data/rocky/", siteDF$countryCode[1], "-", siteDF$localityCode[1], "_ipt_MoF.csv"), MoFFile)
