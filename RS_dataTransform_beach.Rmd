...
Abundance.lf = melt(beachData, id.vars = c(1,11,12,16,19:22), measure.vars = 23:ncol(beachData), 
...
`eventId` is the combination of `Country`, `City`, `Beach`, `Station`, `Transect` and `Level`.
...
eventFile = data.frame(eventID = eventID,
                       ...
                       habitat= paste0("Sandy Beach-", siteDF$Zone),
                       country = siteDF$Country, 
                       locality = siteDF$City)

readr::write_csv(path = paste0(baseDataDir, siteDF$countryCode[1], "-beach_event.csv"), eventFile)
...
readr::write_csv(path = paste0(baseDataDir, siteDF$countryCode[1], "-beach_occurrence.csv"), occurrenceFile)
...
readr::write_csv(path = paste0(baseDataDir, siteDF$countryCode[1], "-beach_MoF.csv"), MoFFile)
