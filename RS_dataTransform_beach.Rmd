...
Abundance = beachData[,22:ncol(beachData)]
...
eventID = paste(siteDF$countryCode, siteDF$localityCode, siteDF$siteCode, siteDF$Station, 
...
```{r savefiles}
readr::write_csv(path = paste0(baseDataDir, siteDF$localityCode[1], "_siteDF.csv"), siteDF)
readr::write_csv(path = paste0(baseDataDir, siteDF$localityCode[1], "_occurrence.csv"), Occurrence)
