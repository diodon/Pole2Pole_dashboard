...
baseDataDir =  "../data/beach/BRA/"

datafileName = paste0(baseDataDir, "Data_SandyBeach_PontalParana_Atami.xlsx")

## taxa name file Abundance
datataxonName.Abund = paste0(baseDataDir, "taxalist.csv")
datataxonNameMatched.Abund = paste0(baseDataDir, "atami_matched.txt")
